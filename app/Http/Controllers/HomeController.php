...
//     dd($d->timings) ;
        ...
        // Home topics
        $HomeNews = Topic::where([['status', 1], ['webmaster_id', $WebmasterSettings->home_content1_section_id], ['expire_date', '>=', date("Y-m-d")], ['expire_date', '<>', null]])->orwhere([['status', 1], ['webmaster_id', $WebmasterSettings->home_content1_section_id], ['expire_date', null]])->orderby('date', env("FRONTEND_TOPICS_ORDER", "asc"))->limit(3)->latest()->get();
        //dd($HomeNews);
        ...
        $HomeGalary = Topic::where([['status', 1], ['webmaster_id', $WebmasterSettings->home_content16_section_id], ['expire_date', '>=', date("Y-m-d")], ['expire_date', '<>', null]])->orwhere([['status', 1], ['webmaster_id', $WebmasterSettings->home_content16_section_id], ['expire_date', null]])->orderby('date', env("FRONTEND_TOPICS_ORDER", "asc"))->limit(9)->get();
// Home Partners
        ...
        // dd($HomePartners);
         ...
         $HomeProjectsTypes = Topic::where([['status', 1], ['webmaster_id', $WebmasterSettings->home_content4_section_id], ['expire_date', '>=', date("Y-m-d")], ['expire_date', '<>', null]])->orwhere([['status', 1], ['webmaster_id', $WebmasterSettings->home_content4_section_id], ['expire_date', null]])->orderby('date', env("FRONTEND_TOPICS_ORDER", "asc"))->limit(12)->get();

        $HomeStrategic = Topic::where([['status', 1], ['webmaster_id', $WebmasterSettings->home_content5_section_id], ['expire_date', '>=', date("Y-m-d")], ['expire_date', '<>', null]])->orwhere([['status', 1], ['webmaster_id', $WebmasterSettings->home_content5_section_id], ['expire_date', null]])->orderby('date', env("FRONTEND_TOPICS_ORDER", "asc"))->limit(12)->get();
        // Get Latest News
       ...
       // dd($institutions);
        ...
        $TextBanners = Banner::where('section_id', $WebmasterSettings->home_text_banners_section_id)->where('status',
         ...
         $HomeProjects = Topic::where([['status', 1], ['webmaster_id', $WebmasterSettings->home_content6_section_id], ['expire_date', '>=', date("Y-m-d")], ['expire_date', '<>', null]])->orwhere([['status', 1], ['webmaster_id', $WebmasterSettings->home_content6_section_id], ['expire_date', null]])->orderby('date', env("FRONTEND_TOPICS_ORDER", "asc"))->limit(6)->latest()->get();

         $HomeEvents = Topic::where([['status', 1], ['webmaster_id', $WebmasterSettings->home_content7_section_id], ['expire_date', '>=', date("Y-m-d")], ['expire_date', '<>', null]])->orwhere([['status', 1], ['webmaster_id', $WebmasterSettings->home_content7_section_id], ['expire_date', null]])->orderby('date', env("FRONTEND_TOPICS_ORDER", "asc"))->get();

          $HomePartnerInst = Topic::where([['status', 1], ['webmaster_id', $WebmasterSettings->home_content8_section_id], ['expire_date', '>=', date("Y-m-d")], ['expire_date', '<>', null]])->orwhere([['status', 1], ['webmaster_id', $WebmasterSettings->home_content8_section_id], ['expire_date', null]])->orderby('date', env("FRONTEND_TOPICS_ORDER", "asc"))->get();

           $Home = Topic::where([['status', 1], ['webmaster_id', $WebmasterSettings->home_content7_section_id], ['expire_date', '>=', date("Y-m-d")], ['expire_date', '<>', null]])->orwhere([['status', 1], ['webmaster_id', $WebmasterSettings->home_content7_section_id], ['expire_date', null]])->orderby('date', env("FRONTEND_TOPICS_ORDER", "asc"))->get();


        $HomeCampaigns = Topic::where([['status', 1], ['webmaster_id', $WebmasterSettings->home_content9_section_id], ['expire_date', '>=', date("Y-m-d")], ['expire_date', '<>', null]])->orwhere([['status', 1], ['webmaster_id', $WebmasterSettings->home_content9_section_id], ['expire_date', null]])->orderby('date', env("FRONTEND_TOPICS_ORDER", "asc"))->limit(12)->get();
          $HomeStatistics = Topic::where([['status', 1], ['webmaster_id', $WebmasterSettings->home_content10_section_id], ['expire_date', '>=', date("Y-m-d")], ['expire_date', '<>', null]])->orwhere([['status', 1], ['webmaster_id', $WebmasterSettings->home_content10_section_id], ['expire_date', null]])->orderby('date', env("FRONTEND_TOPICS_ORDER", "asc"))->limit(12)->get();
       ...
       /* foreach($HomePage->webmasterSection->customFields->where("in_listing",true) as $customField){
        ...
        dd($t_field->field_value);
      }
            }
        }*/


        $photos = Photo::where('topic_id', 83)->get();
        


            $AllSections = Section::orderby('row_no', 'asc')->get();
           
                    $category_topics = array();
                    $TopicCategories = TopicCategory::get();
                

        return view("frontEnd.home",
            compact("lang","institutions",
                "WebmasterSettings",
                "SliderBanners",
                "TextBanners",
                "PageTitle",
        ...
        if (!empty($WebmasterSection)) {
            ...
            if (count($AllSections) > 0) {
                foreach ($AllSections as $AllSection) {
                    ...
                    $Topics = Topic::where([['webmaster_id', '=', $WebmasterSection->id], ['status', 1], ['expire_date', '>=', date("Y-m-d")], ['expire_date', '<>', null]])->orWhere([['webmaster_id', '=', $WebmasterSection->id], ['status', 1], ['expire_date', null]])->whereIn('id', $category_topics)->orderby('id', 'DESC')->get();
            ...
            if (!empty($CurrentCategory)) {
                ...
                })->whereIn('id', $category_topics)->orderby('id', 'DESC')->paginate(env('FRONTEND_PAGINATION'));
                ...
                // Topics if NO Cat_ID
                $Topics = Topic::where([['webmaster_id', '=', $WebmasterSection->id], ['status', 1], ['expire_date', '>=', date("Y-m-d")], ['expire_date', '<>', null]])->orWhere([['webmaster_id', '=', $WebmasterSection->id], ['status', 1], ['expire_date', null]])->orderby('id', 'DESC')->paginate(env('FRONTEND_PAGINATION'));
                // Get Most Viewed
  ...
  $institutions = $this->institutions($WebmasterSettings->institutions_section_id);
    ...
    public function institutions($section_id)
    {
        return Topic::where([['status', 1], ['webmaster_id', $section_id], ['expire_date', '>=', date("Y-m-d")], ['expire_date', '<>', null]])->orwhere([['status', 1], ['webmaster_id', $section_id], ['expire_date', null]])->orderby('row_no', 'desc')->limit(5)->get();
    }
  ...
  $institutions = $this->institutions($WebmasterSettings->institutions_section_id);
    ...
    public function send_notification($WebmasterSection, $Topic, $Case = "")
    {
     ...
     public function fatwaRequest()
    {
        return $this->FatwaRequestPageByLang("");
    }

    public function FatwaRequestPageByLang($lang)
    {
       ...
       $lang = App::getLocale();\Session::put('locale', $lang);
        ...
        $id = $WebmasterSettings->fatwa_req_page_id;
        $Topic = Topic::where('status', 1)->find($id);
  ...
  $institutions = $this->institutions($WebmasterSettings->institutions_section_id);
                ...
                return view("frontEnd.fatwaRequest",
                    compact("lang","institutions",
                        "WebmasterSettings",
                        "LatestNews",
                        "Topic",
    ...
    public function FatwaRequestPageSubmit(Request $request)
    {
        ...
        $this->validate($request, [
          ...
          $fatwa = new FatwaRequest();
          $fatwa->fullName = $request->fullName;
          $fatwa->email = $request->email;
          $fatwa->phone = $request->phone;
          $fatwa->city = $request->city;
          $fatwa->title = $request->title;
          $fatwa->details = $request->details;
          $fatwa->save();
    ...
    public function presentingProject()
    {
        return $this->PresentingProjectPageByLang("");
    }

    public function PresentingProjectPageByLang($lang)
    {
       ...
       $lang = App::getLocale();\Session::put('locale', $lang);
        ...
        $id = $WebmasterSettings->pres_proj_page_id;
        $Topic = Topic::where('status', 1)->find($id);
  ...
  $institutions = $this->institutions($WebmasterSettings->institutions_section_id);
                ...
                return view("frontEnd.present_project",
                    compact("lang","institutions",
                        "WebmasterSettings",
                        "LatestNews",
                        "Topic",
    ...
    public function PresentingProjectPageSubmit(Request $request)
    {
        ...
        $this->validate($request, [
          ...
          $project->project_details = $request->project_details;
           ...
           $uploadPath = "uploads/projects/files";
            // Start of Upload Files
            $formFileName = "project_file";
            $fileFinalName = "";
            if ($request->$formFileName != "") {
                $fileFinalName = time() . rand(1111,
                        9999) . '.' . $request->file($formFileName)->getClientOriginalExtension();
          ...
          $project->project_file = $fileFinalName;
          $project->save();
    ...
    public function ZakatDeclaration()
    {
        return $this->ZakatDeclarationPageByLang("");
    }

    public function ZakatDeclarationPageByLang($lang)
    {

       if ($lang != "") {
            // Set Language
            App::setLocale(d);
            \Session::put('locale', d);
        }
        // General Webmaster Settings
        $WebmasterSettings = WebmasterSetting::find(1);

        $id = $WebmasterSettings->zakat_dec_page_id;
        $Topic = Topic::where('status', 1)->find($id);
  ...
  $institutions = $this->institutions($WebmasterSettings->institutions_section_id);
                ...
                return view("frontEnd.zakat_declaration",
                    compact("lang","institutions",
                        "WebmasterSettings",
                        "LatestNews",
                        "Topic",
    ...
    public function ZakatDeclarationPageSubmit(Request $request)
    {
        ...
        $this->validate($request, [
            ...
            'address'=>'required',
            'auditorAddress'=>'required',
            'auditorName'=>'required',
            'auditorEmail'=>'required',
            'mainActivity'=>'required',
            'descActivity'=>'required'
            
        ]);
          $dec = new ZakatDeclaration();
          $dec->taxpayer = $request->taxpayer;
          $dec->idNumber = $request->idNumber;
          $dec->taxNumber = $request->taxNumber;
          $dec->bank_name = $request->bank_name;
          $dec->phone = $request->phone;
          $dec->accountNumber = $request->accountNumber;
          $dec->governorate = $request->governorate;
          $dec->address = $request->address;
          $dec->auditorAddress = $request->auditorAddress;
          $dec->auditorName = $request->auditorName;
          $dec->auditorPhone = $request->auditorPhone;
          $dec->auditorEmail = $request->auditorEmail;
          $dec->mainActivity = $request->mainActivity;
          $dec->descActivity = $request->descActivity;
          $dec->email = $request->email;
          $dec->fax = $request->fax;
          $dec->tel = $request->tel;
    ...
    public function LibraryTestPageByLang($lang)
    {
        ...
        // get User Details
            ...
            // .. end of .. Page Title, Description, Keywords
                  $BooksLibrary = Topic::where([['status', 1], ['webmaster_id', $WebmasterSettings->home_content12_section_id], ['expire_date', '>=', date("Y-m-d")], ['expire_date', '<>', null]])->orwhere([['status', 1], ['webmaster_id', $WebmasterSettings->home_content12_section_id], ['expire_date', null]])->where('id','<>','210')->orderby('date', env("FRONTEND_TOPICS_ORDER", "desc"))->paginate(8);
              //    dd($Categories);
            // Send all to the view
...
public function Gallery()
    {
        return $this->GalleryPageByLang("");
    }

    public function GalleryPageByLang($lang)
    {
        ...
        // get User Details
                 ...
                 $id = $WebmasterSettings->gallery_page_id;
               $Topic = Topic::where('status', 1)->find($id);
  ...
  $institutions = $this->institutions($WebmasterSettings->institutions_section_id);
            ...
            // .. end of .. Page Title, Description, Keywords
                   $HomeGallary = Topic::where([['status', 1], ['webmaster_id', $WebmasterSettings->home_content16_section_id], ['expire_date', '>=', date("Y-m-d")], ['expire_date', '<>', null]])->orwhere([['status', 1], ['webmaster_id', $WebmasterSettings->home_content16_section_id], ['expire_date', null]])->orderby('date', env("FRONTEND_TOPICS_ORDER", "asc"))->get();
...
public function Events()
    {
        return $this->EventsPageByLang("");
    }

    public function EventsPageByLang($lang)
    {
        ...
        // get User Details
                 ...
                 $id = $WebmasterSettings->event_page_id;
               $Topic = Topic::where('status', 1)->find($id);
    ...
    {
        return $this->ZakatCalculationsPageByLang("");
    }

    public function ZakatCalculationsPageByLang($lang)
    {
       ...
       $lang = App::getLocale();\Session::put('locale', $lang);
        ...
        $id = $WebmasterSettings->zakat_calcu_page_id;
        $Topic = Topic::where('status', 1)->find($id);
  ...
  $institutions = $this->institutions($WebmasterSettings->institutions_section_id);
                ...
                // .. end of .. Page Title, Description, Keywords
                $websiteNavbar  =  Menu1::with('children')->orderBy('order')->where('type','web')->where('status','1')->get();
                $ZakatCalculations = Topic::where([['status', 1], ['webmaster_id', $WebmasterSettings->home_content11_section_id], ['expire_date', '>=', date("Y-m-d")], ['expire_date', '<>', null]])->orwhere([['status', 1], ['webmaster_id', $WebmasterSettings->home_content11_section_id], ['expire_date', null]])->orderby('date', env("FRONTEND_TOPICS_ORDER", "asc"))->get();

                return view("frontEnd.zakat_calculations",
                    compact("lang","institutions",
                        "WebmasterSettings",
                        "LatestNews",
                        "Topic",
        ...
        public function ZakatRealEstate()
    {
        return $this->ZakatRealEstatePageByLang("");
    }

    public function ZakatRealEstatePageByLang($lang)
    {
        ...
        $id = $WebmasterSettings->zakat_calcu_real_page_id;
        $Topic = Topic::where('status', 1)->find($id);
                ...
                $LatestNews = $this->latest_topics($WebmasterSettings->latest_news_section_id);
                 $institutions = $this->institutions($WebmasterSettings->institutions_section_id);
                return view("frontEnd.zakat_calculations_realEstate",
                    compact("lang","institutions",
                        "WebmasterSettings",
                        "LatestNews",
                        "Topic",
 ...
 public function ZakatCompany()
    {
        return $this->ZakatCompanyPageByLang("");
    }

    public function ZakatCompanyPageByLang($lang)
    {
       ...
       $lang = App::getLocale();\Session::put('locale', $lang);
        ...
        $id = $WebmasterSettings->zakat_calcu_company_page_id;
        $Topic = Topic::where('status', 1)->find($id);
                ...
                $LatestNews = $this->latest_topics($WebmasterSettings->latest_news_section_id);
  $institutions = $this->institutions($WebmasterSettings->institutions_section_id);
                return view("frontEnd.zakat_calculations_company",
                    compact("lang","institutions",
                        "WebmasterSettings",
                        "LatestNews",
                        "Topic",
    ...
    public function ZakatCrops()
    {
        return $this->ZakatCropsPageByLang("");
    }

    public function ZakatCropsPageByLang($lang)
    {
       ...
       $lang = App::getLocale();\Session::put('locale', $lang);
        ...
        $id = $WebmasterSettings->zakat_calcu_crops_page_id;
        $Topic = Topic::where('status', 1)->find($id);
                ...
                $LatestNews = $this->latest_topics($WebmasterSettings->latest_news_section_id);
  $institutions = $this->institutions($WebmasterSettings->institutions_section_id);
                return view("frontEnd.zakat_calculations_crops",
                    compact("lang","institutions",
                        "WebmasterSettings",
                        "LatestNews",
                        "Topic",
...
public function ZakatCash()
    {
        return $this->ZakatCashPageByLang("");
    }

    public function ZakatCashPageByLang($lang)
    {
       ...
       $lang = App::getLocale();\Session::put('locale', $lang);
        ...
        $id = $WebmasterSettings->zakat_calcu_cash_page_id;
        $Topic = Topic::where('status', 1)->find($id);
                ...
                $LatestNews = $this->latest_topics($WebmasterSettings->latest_news_section_id);
  $institutions = $this->institutions($WebmasterSettings->institutions_section_id);
                return view("frontEnd.zakat_calculations_cash",
                    compact("lang","institutions",
                        "WebmasterSettings",
                        "LatestNews",
                        "Topic",
    ...
    public function Fatwes()
    {
        return $this->FatwesPageByLang("");
    }

    public function FatwesPageByLang($lang)
    {
        ...
        // get User Details
                 ...
                 $id = $WebmasterSettings->fatwes_page_id;
                // dd($id);
               $Topic = Topic::where('status', 1)->find($id);
  ...
  $institutions = $this->institutions($WebmasterSettings->institutions_section_id);
            ...
            // .. end of .. Page Title, Description, Keywords
                  $Fatwes = Topic::where([['status', 1], ['webmaster_id', $WebmasterSettings->home_content13_section_id], ['expire_date', '>=', date("Y-m-d")], ['expire_date', '<>', null]])->orwhere([['status', 1], ['webmaster_id', $WebmasterSettings->home_content13_section_id], ['expire_date', null]])->orderby('date', env("FRONTEND_TOPICS_ORDER", "asc"))->paginate(10);
              //    dd($Categories);
            // Send all to the view
            return view("frontEnd.fatwes",
                compact("lang","institutions",
                    "WebmasterSettings",
                    "LatestNews",
    ...
    {
        return $this->AchievementsPageByLang("");
    }

    public function AchievementsPageByLang($lang)
    {
        ...
        // get User Details
                 ...
                 $id = $WebmasterSettings->achievements_page_id;
                // dd($id);
               $Topic = Topic::where('status', 1)->find($id);
            ...
            // .. end of .. Page Title, Description, Keywords
                  $Achievements = Topic::where([['status', 1], ['webmaster_id', $WebmasterSettings->home_content14_section_id], ['expire_date', '>=', date("Y-m-d")], ['expire_date', '<>', null]])->orwhere([['status', 1], ['webmaster_id', $WebmasterSettings->home_content14_section_id], ['expire_date', null]])->where('id','<>','242')->orderby('row_no', 'desc')->get();
              //    dd($Achievements);
  $institutions = $this->institutions($WebmasterSettings->institutions_section_id);
 ...
 public function AboutPage()
    {
        return $this->AboutPageByLang("");
    }

    public function AboutPageByLang($lang)
    {
        ...
        // get User Details
                 ...
                 $id = $WebmasterSettings->about_page_id;
                // dd($id);
               $Topic = Topic::where('status', 1)->find($id);
        ...
        $aboutPage = [];
        if ($WebmasterSettings->about_page_id > 0) {
            $aboutPage = Topic::where("status", 1)->find($WebmasterSettings->about_page_id);
        }
         $files = Topic::where([['status', 1], ['webmaster_id', $WebmasterSettings->about_content1_section_id], ['expire_date', '>=', date("Y-m-d")], ['expire_date', '<>', null]])->orwhere([['status', 1], ['webmaster_id', $WebmasterSettings->about_content1_section_id], ['expire_date', null]])->orderby('date', env("FRONTEND_TOPICS_ORDER", "asc"))->get();
    ...
    {
        $institutions = Topic::where([['status', 1], ['webmaster_id', 6668], ['expire_date', '>=', date("Y-m-d")], ['expire_date', '<>', null]])->orwhere([['status', 1], ['webmaster_id', 6668], ['expire_date', null]])->orderby('row_no', 'desc')->take(5)->get();
        $institutionss = Topic::where([['status', 1], ['webmaster_id', 6668], ['expire_date', '>=', date("Y-m-d")], ['expire_date', '<>', null]])->orwhere([['status', 1], ['webmaster_id', 6668], ['expire_date', null]])->orderby('row_no', 'desc')->get();
        $PageTitle = 'Institutions';
        $PageDescription = '';
        $PageKeywords = '';
        $WebmasterSettings = WebmasterSetting::find(1);
        return view('frontEnd.institutions', compact('institutions', 'institutionss', 'PageTitle', 'PageDescription', 'PageKeywords', 'WebmasterSettings'));
    }
}