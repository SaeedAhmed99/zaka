...
<section id="content">
        ...
        <div class="form-block">
            <h3 style="text-align: center;">{{__('frontend.cash_zakat_cal')}}</h3>
        </div>
    </div>
<div class="col-lg-12">
  <table class="table table-bordered table-striped">
    <form id="calculate-zakat-on-cash-form">
    <tbody>
        <tr>
            <td>1</td>
            <td>{{__('frontend.zakat14')}}</td>
             <td><input class="form-control" id="nissab" required></td>
            
        </tr>
        <tr>
            <td>2</td>
            <td>{{__('frontend.zakat15')}}</td>
            <td>
        ...
        <tr>
            ...
            <td>
                ...
                @else
                <select class="form-control" name="" id="year_value">
...
@if($lang == 'ar')
<script src="{{ URL::asset('assets/frontend/js/zakat_calculations/zakat_on_cash/script_ar3bea.js') }}"></script>
@else
<script src="{{ URL::asset('assets/frontend/js/zakat_calculations/zakat_on_cash/script3bea.js') }}"></script>
@endif