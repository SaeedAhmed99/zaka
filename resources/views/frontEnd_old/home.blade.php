                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="row" style="margin-bottom: 0;">
                             @foreach($LatestNews as $HomeTopic)
                                ...
                                <div class="col-lg-{{$col_width}}">
                                    <div class="box">
                                        <div class="box-gray aligncenter" style="height: 320px !important" >
                                          @if($HomeTopic->icon !="")
                                                    <div class="icon">
                                                        <i class="fa {{$HomeTopic->icon}} fa-3x"></i>
                                                    </div>
                                                @elseif($HomeTopic->photo_file !="")
                                                <a
                                            href="{{ Helper::topicURL($HomeTopic->id) }}">
                                                    <img src="{{ URL::to('uploads/topics/'.$HomeTopic->photo_file) }}"
                                                         alt="{{ $title }}" style="height: 180px !important" />
                                                     </a>
                                                @endif
                                                <a
                                            href="{{ Helper::topicURL($HomeTopic->id) }}">
                                                <h4 style="font-weight: 550 !important;">{{ $title }}</h4>
                                            </a>
                                               <!--  @if($HomeTopic->$details !="")
                                                       <p  style="color:#000 !important;text-align: justify;">{!! mb_substr(strip_tags($HomeTopic->$details),0, 300)."..." !!}
                                        &nbsp; <a
                                            href="{{ Helper::topicURL($HomeTopic->id) }}">{{ __('frontend.readMore') }}
                                            <i
                                                class="fa fa-caret-{{ @Helper::currentLanguage()->right }}"></i></a>
