                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="home-row-head">
                            <h2 class="heading">{{ __('frontend.homeContents5Title') }}</h2>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="home-row-head">
                            <h3 class="heading" >{{ __('frontend.homeContents6Title') }}</h3>
                        ...
                        <div class="row" style="margin-bottom: 0;">
                             @foreach($HomeStrategic as $HomeTopic)
                                ...
                                <div class="col-lg-{{$col_width}}">
                                    <div class="box">
                                        <div class="box-gray aligncenter" style="height:250px !important">
                                          @if($HomeTopic->icon !="")
                                                    <div class="icon">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                          ...
                          <div class="home-row-head">
                            <h2 class="heading" style="    font-size: 25px !important; ">{{ __('frontend.homeContents7Title') }}</h2>
                            <small>{{ __('frontend.homeContents7desc') }}</small>
                        </div>
                        </div>
                        <div class="row" style="margin-bottom: 0;">
                             @foreach($HomeStatistics as $HomeTopic)
                                <?php
                                if ($HomeTopic->$title_var != "") {
                                    $title = $HomeTopic->$title_var;
                                } else {
                                ...
                                if ($section_url == "") {
                                    ...
                                    $col_width = 12;
                                    if (count($HomeStatistics) == 2) {
                                        $col_width = 6;
                                    }
                                    if (count($HomeStatistics) == 3) {
                                        $col_width = 4;
                                    }
                                    if (count($HomeStatistics) > 3) {
                                        $col_width = 2;
                                ...
                                <div class="col-lg-{{$col_width}}">
                                    <div class="box">
                                        <div class="box-gray aligncenter" style="height: 180px">
                                          @if($HomeTopic->icon !="")
                                                    <div class="" style="color:#F26522 !important;font-size:32px;display:inline-block;">
                                                        <i class="fa {{$HomeTopic->icon}}"></i>
                                                    </div>
                                                @elseif($HomeTopic->photo_file !="")
                                                    <img src="{{ URL::to('uploads/topics/'.$HomeTopic->photo_file) }}"
                                                ...
                                                @endif
                                                @if($HomeTopic->$details !="")
                                                    <p style="font-size:20px;margin-top:-6px">{!! $HomeTopic->$details !!}</p>
                                                @endif
                                                <h4 style="font-weight: 550 !important;margin-top: 0px !important;">{{ $title }}</h4>
   ...
   @if(count($LatestNews)>0)
        ...
        <section class="content-row-bg">
            <div class="container">
                <div class="row">
                    <div class="home-row-head">
                        <h2 class="heading">{{ __('frontend.homeContents8Title') }}</h2>
        ...
        <section class="content-row-no-bg top-line">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="home-row-head">
                            <h2 class="heading">{{ __('frontend.homeContents11Title') }}</h2>
                            <!-- <small>{{ __('frontend.homeContents5desc') }}</small> -->
                        </div>
    ...
    <section class="content-row-bg">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="home-row-head">
                        <h2 class="heading">{{ __('frontend.homeContents13Title') }}</h2>
                        <small style="color: #fff">{{ __('frontend.homeContents13Title') }}</small>
                    </div>
                <section id="projects">
                                                ...
                                                <div class="relative">
                                                    <div class="item-thumbs">
                                                       ...
                                                       data-width="380" data-height="380" ><blockquote cite="https://www.facebook.com/KeenesListcom-126649220715963/" class="fb-xfbml-parse-ignore">
                                                        <a href="https://www.facebook.com/zakatpal/">zakatpal</a></blockquote
                                                        ></div>
                                                    </div>
                                                </div>
                                            </li>
        ...
        <div class="container">
            <div class="row">
                <div class="home-row-head">
                    ...
                    <small style="color: #fff">{{ __('frontend.homeContents2desc') }}</small>
                </div>
            </div>
            <div class="row">
                @foreach($HomeGalary as $photo)
                    <div class="col-md-4">
                        <div class="imgDiv position-relative " data-toggle="modal" data-target="#myModal">
                            <img src="{{ URL::to('uploads/topics/'.$photo->photo_file) }}" style="width:100%">
                            <div class="cover d-flex justify-content-center align-items-center">
                                <span> صورة <label>30</label></span>
                                <img src="{{ URL::asset('assets/frontend/img/photos-icon.svg') }}" class="img-fluid" style="width: 30px;">
                            </div>
                        </div>
                    </div>
                @endforeach 
                ...
                {{-- <div class = "gallery">
                    @foreach($HomeGalary as $photo)
                        <div class="clipped-border">
                            <img src="{{ URL::to('uploads/topics/'.$photo->photo_file) }}" id="clipped">
                        </div>
                    @endforeach        
                </div> --}}
        </div>
