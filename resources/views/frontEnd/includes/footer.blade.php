                ...
                <div class="col-lg-{{$bx1w}}">
                    <div class="widget contacts">
                        ...
                        @if(Helper::GeneralSiteSettings("contact_t1_" . @Helper::currentLanguage()->code) !="")
                            <address>
                                <span>{{ __('frontend.address') }}:</span><br>
                        ...
                        @if(Helper::GeneralSiteSettings("contact_t5") !="")
                            <p>
                                <span>{{ __('frontend.callUs') }}:</span><br>
                        ...
                        @if(Helper::GeneralSiteSettings("contact_t6") !="")
                            <p>
                                <span>{{ __('frontend.email') }}:</strong><br>
                        ...
                        <div class="widget">
                            ...
                            <ul class="link-list">
                                ...
                                @if($institutions->count() > 4)
                                    <li><a href="{{route('InstitutionsPage')}}" style="color:#64a0e3">المزيد</a></li>
                                @endif
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                    <ul class="social-network">
                        ...
                        @if(Helper::GeneralSiteSettings('social_link4'))
                            <li>
                                <a href="{{Helper::GeneralSiteSettings('social_link4')}}" data-placement="top" title="telegram" target="_blank"><i class="fa fa-telegram"></i></a>
                            </li>
                        @endif
