...
use App\Http\Controllers\Dashboard\PresentingProjController;
use App\Http\Controllers\Dashboard\ZakatDeclarationController;
...
// Fatwas Requests
Route::get('/fatwa_requests', [FatwaController::class, 'index'])->name('fatwa_requests');
Route::get('/fatwa_requests/destroy/{id}', [FatwaController::class, 'destroy'])->name('fatwasDestroy');


// Presenting Projects
Route::get('/presenting_projects', [PresentingProjController::class, 'index'])->name('presenting_projects');
Route::get('/presenting_projects/destroy/{id}', [PresentingProjController::class, 'destroy'])->name('projectDestroy');

Route::get('presenting_projects/{id}/download', 'PresentingProjController@download')->name('presenting_projects.download'); 

// Zakat Declaration
Route::get('/zakat_declaration', [ZakatDeclarationController::class, 'index'])->name('zakat_declaration');
Route::get('/zakat_declaration/destroy/{id}', [ZakatDeclarationController::class, 'destroy'])->name('declarationDestroy');
